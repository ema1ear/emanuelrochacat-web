...
assert.match(appScript, /const INTRO_NAME_MS = 1250;/, "El nombre debe permanecer 1,25 segundos.");
assert.match(appScript, /const INTRO_WELCOME_MS = 500;/, "La bienvenida debe permanecer medio segundo.");
assert.match(appScript, /const INTRO_MOVE_MS = 1000;/, "El desplazamiento debe cerrar la entrada en un segundo.");
...
assert.match(introStyles, /@media \(min-width: 768px\)[\s\S]*?\.focus-companion \{ right: -68px; \}/, "La marca debe ocupar el margen exterior en escritorio.");
