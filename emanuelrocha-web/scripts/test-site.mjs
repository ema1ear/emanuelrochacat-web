...
assert.match(appScript, /const INTRO_NAME_MS = 1000;/, "El nombre debe permanecer un segundo.");
assert.match(appScript, /const INTRO_WELCOME_MS = 500;/, "La bienvenida debe permanecer medio segundo.");
assert.match(appScript, /const INTRO_MOVE_MS = 750;/, "El desplazamiento debe cerrar la entrada sin alargarla.");
