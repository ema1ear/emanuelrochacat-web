...
funcionan como expresiones seleccionables, las respuestas continúan visualmente
cada enunciado y nombre y correo cierran el recorrido como una sola frase. La
lógica sigue siendo un formulario HTML accesible; el recorrido progresivo no
