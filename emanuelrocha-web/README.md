...
Los textos generales se concentran en `assets/content.js`. El formulario bilingüe se mantiene en `assets/form-content.js` y el contenido de calibración de Operaciones en `assets/operations-content.js`. Cada modificación debe ir seguida de `npm run build`; el sitemap y todas las páginas localizadas se regeneran automáticamente.
...
- `assets/operations-content.js`: contrato editorial bilingüe y muestras de calibración. Es el punto previsto para el merge de contenido.
