...
La entrada inicial dura 5,5 segundos: el nombre permanece 1,8 segundos, la
bienvenida 0,9 segundos y los desplazamientos horizontal y vertical disponen
de 1,4 segundos cada uno. Se ejecutan como dos fases independientes para que
ningún nodo tenga que acelerar hasta la siguiente posición. Un
contador de `000/100` acompaña esa única entrada y puede pulsarse para omitirla.
En móvil comparte la línea visual del footer sin ocupar espacio de layout; en
escritorio se desplaza al margen exterior de la retícula. Si el sistema solicita
movimiento reducido, tanto la coreografía como el contador se omiten.

Al terminar la entrada, el contador entrega el recorrido a una marca focal
abstracta. Su núcleo se alinea con el centro visual de cada superficie y el
progreso se representa por separado. En las rutas señala la unidad narrativa
activa; en Operaciones recorre los seis archivos también mientras se explora el
índice; en Contacto refleja los pasos reales de cada modalidad y se cierra al
completar el envío. La marca es
