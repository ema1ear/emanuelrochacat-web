...
export const copies = {
    ca: {
        ...
        proseHTML: `Al punt on eliminem el soroll de la teva comunicació comercial. Si la situació no pot continuar així, pots <a href="/ca/accio/" class="btn-inline-option" data-action="narrative" data-intent="A">passar a l’acció ara mateix</a>; si intueixes que alguna cosa falla però encara no veus què, et convido a <a href="/ca/cosmovisio/" class="btn-inline-option" data-action="narrative" data-intent="B">veure com enfoco la meva feina</a>.`,
        A: routeContent.ca.A,
        B: routeContent.ca.B
    },
    es: {
        ...
        proseHTML: `Al punto donde eliminamos el ruido de tu comunicación comercial. Si la situación no puede seguir así, puedes <a href="/es/accion/" class="btn-inline-option" data-action="narrative" data-intent="A">pasar a la acción ahora mismo</a>; si intuyes que algo falla pero todavía no ves qué, te invito a <a href="/es/cosmovision/" class="btn-inline-option" data-action="narrative" data-intent="B">ver cómo enfoco mi trabajo</a>.`,
        A: routeContent.es.A,
        B: routeContent.es.B
    }
};
...
export const routePages = [
    { lang: "ca", key: "home", state: "welcome-ready", heading: "Consultor de comunicació a la Cerdanya", title: "Consultor de comunicació a la Cerdanya | Emanuel Rocha", description: "Consultoria de comunicació per a negocis que necessiten revisar una decisió, explicar millor el seu valor o convertir criteri en un sistema.", index: true },
    { lang: "ca", key: "A", state: "narrative", heading: "Passar a l’acció", title: "Consultoria de comunicació: passar a l’acció | Emanuel Rocha", description: "Una ruta directa per revisar l’encàrrec, entendre què ha de canviar i decidir si cal anàlisi, comunicació o un sistema de treball.", index: true },
    ...
    { lang: "es", key: "home", state: "welcome-ready", heading: "Consultor de comunicación en La Cerdanya", title: "Consultor de comunicación en La Cerdanya | Emanuel Rocha", description: "Consultoría de comunicación para negocios que necesitan revisar una decisión, explicar mejor su valor o convertir criterio en un sistema.", index: true },
    { lang: "es", key: "A", state: "narrative", heading: "Pasar a la acción", title: "Consultoría de comunicación: pasar a la acción | Emanuel Rocha", description: "Una ruta directa para revisar el encargo, entender qué debe cambiar y decidir si hace falta análisis, comunicación o un sistema de trabajo.", index: true },
