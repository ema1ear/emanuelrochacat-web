...
Una promotora quiso corregir una noticia tras protestas. El conflicto era la pérdida cultural. Entregué un plan para reforzar una institución que ya asumía parte de esa función.
...
Una promotora volia corregir una notícia arran de protestes. El conflicte era la pèrdua cultural. Vaig lliurar un pla per reforçar una institució que ja assumia part d’aquella funció.
...
El resultado fue una herramienta operativa, no una formación: quedó construida, probada y entregada.
...
El resultado fue un plan entregado al equipo: responder a la pérdida cultural reforzando una capacidad que ya existía, no creando otra desde cero.
...
El resultat va ser una eina operativa, no una formació: va quedar construïda, provada i lliurada.
...
El resultat va ser un pla lliurat a l’equip: respondre a la pèrdua cultural reforçant una capacitat que ja existia, no creant-ne una de nova.
